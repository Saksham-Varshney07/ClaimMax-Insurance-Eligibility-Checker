...
class ModelInference {
     ...
     */
    static compareFeatures(uploadedFeatures, baseline) {
        if (!baseline) {
     ...
     */
    static computeFeatureScore(uploadedValue, baselineStat) {
     ...
     */
    static makeDecision(matchScore) {
